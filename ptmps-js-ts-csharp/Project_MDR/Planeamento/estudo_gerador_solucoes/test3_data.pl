...
% BASE +7 NÓS
no("Campanha", "CAMPAN", t, f, -8.37109395257277, 41.2290666564043).
no("Foz", "FOZ", t, f, -8.36109395257277, 41.2190666564063).
no("Paranhos", "PARAN", f, f, -8.34109395257277, 41.2080666564062).
no("Bonfim", "BONF", f, f, -8.33109395257277, 41.2040666564063).
no("Massarelos", "MASS", f, f, -8.30509395257277, 41.2170655564061).
no("Ramalde", "RAM", f, f, -8.29909395257277, 41.1970655564063).
no("Cedofeita", "CEDO", t, f, -8.29509395257277, 41.1921635364065).

% TEST3a - 10 pontos de rendição / 2 estações de recolha
...
% TEST3b - 12 pontos de rendição / 2 estações de recolha
...
% TEST3c - 14 pontos de rendição / 2 estações de recolha
% no("Aguiar de Sousa", "AGUIA", t, f, -8.4464785432391, 41.1293363229325).
% no("Besteiros", "BESTR", f, f, -8.34043029659082, 41.217018845589).
% no("Gandra", "GAND", t, f, -8.43958765792976, 41.1956579348384).
...
% TEST3d - 15 pontos de rendição / 2 estações de recolha
% no("Aguiar de Sousa", "AGUIA", t, f, -8.4464785432391, 41.1293363229325).
% no("Besteiros", "BESTR", f, f, -8.34043029659082, 41.217018845589).
% no("Gandra", "GAND", t, f, -8.43958765792976, 41.1956579348384).
% no("Recarei", "RECAR", t, f, -8.42215867462191, 41.1599363478137).
...
% TEST3e - 16 pontos de rendição / 2 estações de recolha
% no("Aguiar de Sousa", "AGUIA", t, f, -8.4464785432391, 41.1293363229325).
...
linha("Paredes_Lordelo", 9, ["LORDL","VANDO", "CEDO", "MOURZ", "PARED"], 29, 14300).
linha("Paredes_Lordelo", 11, ["PARED","MOURZ", "CEDO", "VANDO", "LORDL"], 29, 14300).
...
% BASE +6 LINHAS
linha("Sobrosa_Lordelo", 42, ["SOBRO", "CRIST", "BALTR", "MASS", "MOURZ", "LORDL"], 25, 12500).
linha("Sobrosa_Lordelo", 44, ["LORDL", "MOURZ", "MASS", "BALTR", "CRIST", "SOBRO"], 25, 12500).
...
linha("Gandra_Cedofeita", 50, ["GAND", "MOURZ", "RAM", "MASS", "DIGRJ", "CEDO"], 22, 11000).
linha("Gandra_Cedofeita", 52, ["CEDO", "DIGRJ", "MASS", "RAM", "MOURZ", "GAND"], 22, 11000).
